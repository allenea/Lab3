...
public void TestFiveOfAKindEval() {
	...
	@Test 
 	public void TestIsHandStraightFlush() { 
 		...
 		assertEquals(hs.getKickers().get(eCardNo.FirstCard.getCardNo()).geteSuit(), eSuit.SPADES); 
 		// FOAK has one kicker. Was it a King? 
 		assertEquals(hs.getKickers().get(eCardNo.FirstCard.getCardNo()).geteRank(), eRank.EIGHT); 
 	} 
 	@Test 
	...
	@Test 
 	...
 	//COMPLETED BELOW HERE ERIC 5:30 3/21/2016
 	...
 	@Test 
 	public void TestHandThreeOfAKingEval() { 
 	...
 	@Test 
 	public void TestIsHandThreeOfAKind2() { 
 
 
 		HandScore hs = new HandScore(); 
 		ArrayList<Card> HandThreeOfAKind = new ArrayList<Card>(); 
 		HandThreeOfAKind.add(new Card(eSuit.HEARTS, eRank.NINE, 0)); 
 		HandThreeOfAKind.add(new Card(eSuit.SPADES, eRank.SEVEN, 0)); 
 		HandThreeOfAKind.add(new Card(eSuit.CLUBS, eRank.THREE, 0)); 
 		HandThreeOfAKind.add(new Card(eSuit.DIAMONDS, eRank.THREE, 0)); 
 		HandThreeOfAKind.add(new Card(eSuit.HEARTS, eRank.THREE, 0)); 
 	...
 	@Test 
 	public void TestHandThreeOfAKingEval2() { 
	...
	@Test 
 	public void TestHandTwoPairEval2() { 
	...
	@Test 
 	public void TestHandTwoPairEval3() { 
	...
	@Test 
 	public void TestIsHandPair() { 
 		...
 		HandPair.add(new Card(eSuit.DIAMONDS, eRank.SEVEN, 0)); 
 		HandPair.add(new Card(eSuit.HEARTS, eRank.SIX, 0));
 		HandPair.add(new Card(eSuit.SPADES, eRank.FOUR, 0)); 
 		HandPair.add(new Card(eSuit.CLUBS, eRank.FOUR, 0)); 
	...
	@Test 
 	public void TestIsHandPair2() { 
 		...
 		HandScore hs = new HandScore(); 
 		ArrayList<Card> HandPair = new ArrayList<Card>(); 
 		HandPair.add(new Card(eSuit.DIAMONDS, eRank.QUEEN, 0)); 
 		HandPair.add(new Card(eSuit.SPADES, eRank.SEVEN, 0)); 
 		HandPair.add(new Card(eSuit.SPADES, eRank.SIX, 0)); 
 		HandPair.add(new Card(eSuit.HEARTS, eRank.SIX, 0)); 
 		HandPair.add(new Card(eSuit.HEARTS, eRank.TWO, 0)); 
	...
	@Test 
 	public void TestIsHandPair3() { 
 		...
 		HandScore hs = new HandScore(); 
 		ArrayList<Card> HandPair = new ArrayList<Card>(); 
 		HandPair.add(new Card(eSuit.CLUBS, eRank.NINE, 0)); 
 		HandPair.add(new Card(eSuit.SPADES, eRank.SEVEN, 0)); 
 		HandPair.add(new Card(eSuit.CLUBS, eRank.SEVEN, 0)); 
 		HandPair.add(new Card(eSuit.SPADES, eRank.SIX, 0)); 
 		HandPair.add(new Card(eSuit.CLUBS, eRank.TWO, 0)); 
